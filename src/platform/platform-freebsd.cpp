/*
 * FreeBSD platform backend implementation.
 *
 * Implements platform-specific operations for FreeBSD systems.
 * Handles hybrid-graphics detection and GPU render node management.
 *
...
class platform_freebsd_t : public platform_backend_t
{
public:
    ...
    {
        /*
         * FreeBSD: detect GPUs with usable render nodes to avoid
         * multi-GPU DMA buffer sharing failures on hybrid-graphics laptops.
         *
        ...
        /* Multiple GPUs have working GBM — no filtering needed */
        return strdup("");
    }
    ...
    {
        /* Get the real UID/GID from environment or nobody user */
        uid_t uid = getuid();
        gid_t gid = getgid();
